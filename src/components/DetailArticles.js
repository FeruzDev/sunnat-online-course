...
const DetailArticles = (props) => {
    ...
    const postBook = (data) => {
        axios.patch(API_PATH + "items/articles/" + props.match.params.id, {
            ...
            .then(res => {
                console.log(res)
                setModal(false)
                axios.get(API_PATH + "items/articles/" + props.match.params.id)
                    .then(res=>{
    ...
    const deleteFc = () => {
        axios.delete(API_PATH + "items/articles/" + props.match.params.id)
            .then(res=>{
                history.push("/personal-articles")
            })
    }
    useEffect(()=>{
    ...
    return (
        <div className="detail pb-5 min-vh-100">
            <div className="container pt-5">
                <div className="row">
                    <div className="col-md-4">
                        ...
                        {
                            window.location.pathname.slice(0, 16) === "/detail-articles"
                                ?
                                ""
                                :
            ...
            <Modal isOpen={modal} toggle={toggle} className={props.className}>
                ...
                <div className="d-flex justify-content-between w-100 pl-3 pt-2 pr-3 align-items-center">
                    <h4 className="m-0">Maqolani o'zgartirish</h4>
                ...
                <ModalBody>
                    ...
                    <input
                        name="file"
                        className="form-control mt-3"
                        placeholder="Maqola faylini kiriting"
                        type="file"
                        required
                        onChange={pic2}
                        id="n9"
