...
const DetailNewsGlobal = (props) => {
    ...
    const postBook = (data) => {
        axios.patch(API_PATH + "items/news/" + props.match.params.id, {
    ...
    const deleteFc = () => {
        axios.delete(API_PATH + "items/news/" + props.match.params.id)
            .then(res=>{
...
export default DetailNewsGlobal;