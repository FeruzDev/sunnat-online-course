...
const DetailVideo = (props) => {
    ...
    const postBook = (data) => {
        ...
        axios.patch(API_PATH + "items/videos/" + props.match.params.id + "/update", {
            ...
            .then(res => {
                console.log(res)
                setModal(false)
                axios.get(API_PATH + "items/videos/" + props.match.params.id)
                    .then(res=>{
    ...
    const deleteFc = () => {
        axios.delete(API_PATH + "items/videos/" + props.match.params.id + "/delete")
            .then(res=>{
                history.push("/personal-videos")
            })
    }
    useEffect(()=>{
            ...
            <div className="container pt-5">
                <div className="row">
                    <div className="col-md-4">
                        <video controls   className="w-100" src={item.file}/>
                        {
                            window.location.pathname.slice(0, 20) === "/detail-video-global"
                                ?
                                ""
                                :
