...
const PersonalArticles = (props) => {
    ...
    const postBook = (data) => {
        ...
        axios.post(API_PATH + "items/articles/create",  newData)
            .then(res => {
                console.log(res)
                getBooks()
                setModal(false)
    ...
    const getBooks = () => {
        axios.get(API_PATH + `items/articles?filter[avtor][_eq]=${localStorage.getItem("email")}`)
            .then(res => {
        ...
        <div className="books">
                ...
                <div className="row">
                    <div className="col-md-9">
                        <div className="d-flex justify-content-between">
                            <h2 className="mt-3">Shaxsiy maqolalar</h2>
                        </div>
                        <div className="row">
                            {
            ...
            <Modal isOpen={modal} toggle={toggle} className={props.className}>
                <div className="d-flex justify-content-between w-100 pl-3 pt-2 pr-3 align-items-center">
                    <h4 className="m-0">Maqolani kiriting</h4>
                ...
                <ModalBody>
                    <input
                        ...
                        placeholder="Maqolani nomini kiriting"
                        required
                        id="n1"
                    />
                    <textarea
