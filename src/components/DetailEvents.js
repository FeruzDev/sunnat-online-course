...
const DetailEvents = (props) => {
    ...
    const postBook = (data) => {
        axios.patch(API_PATH + "items/events/" + props.match.params.id, {
            ...
            .then(res => {
                console.log(res)
                setModal(false)
                axios.get(API_PATH + "items/events/" + props.match.params.id)
                    .then(res=>{
    ...
    const deleteFc = () => {
        axios.delete(API_PATH + "items/events/" + props.match.params.id)
            .then(res=>{
                history.push("/personal-events")
            })
    }
    useEffect(()=>{
            ...
            <div className="container pt-5">
                <div className="row">
                    <div className="col-md-4">
                        ...
                        {
                            window.location.pathname.slice(0, 14) === "/detail-events"
                                ?
                                ""
                                :
